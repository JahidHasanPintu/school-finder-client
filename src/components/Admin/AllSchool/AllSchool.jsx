            ...
            <div className="overflow-x-auto">
                <div className="px-1 border-b">
                    <Link to={"/admin/addschool"}>
                        <button className="mb-2 bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded">Add School </button></Link>
                </div>
                        ...
                        {schools.map((school, index) => (
                            <tr key={school._id}>
                                ...
                                <td>
                                    <div className='flex'>
                                        <div className="px-1 border-b">
                                            <button onClick={()=>handleEdit(school)} className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded">Edit </button>
                                        </div>
                                        <div className="px-1 border-b">
                                            <button onClick={()=>handleDelete(school._id)} className="bg-red-500 hover:bg-red-600 text-white py-1 px-2 rounded">Delete </button>
                                        </div>
