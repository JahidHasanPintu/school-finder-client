...
const Search = () => {
  ...
  return (
    <div className="my-5 mx-2 grid grid-cols-6 gap-x-3 relative">
      <div className=" col-span-4 mb-28">
        <form className="mx-10 w-[92%] p-2">
          <label
            for="default-search"
            class="m-10 text-sm font-medium text-gray-900 sr-only dark:text-white"
          >
            Search
          </label>
          <div class="relative">
          ...
          <h2 className="m-2">
            Showing {schoolData?.schoolsOnCurrentPage} out of{" "}
            {schoolData?.totalSchools} schools
          </h2>
        </form>
        {isLoading ? (
          <Loading />
      ...
      <div className="m  col-span-2 mb-28 mr-10  p-2 rounded">
